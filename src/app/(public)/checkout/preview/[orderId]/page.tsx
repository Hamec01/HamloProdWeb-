...
function ContractIframe({ html }: { html: string }) {
  // The HTML is stored server-side and never comes from untrusted user input;
  // it is generated by our own template functions.  We use a sandboxed iframe
  // with allow-same-origin omitted to further reduce risk.
